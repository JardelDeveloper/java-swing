...
public class TelaParImpar extends javax.swing.JFrame {
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        // TODO add your handling code here:
        int verifica = Integer.parseInt(txtValor.getText());
        String abertura = "<html><strong>";
        String fechamento = "</html></strong>";
        if (verifica%2 == 0) {
            if (verifica!=0){
                lblResultado.setText(abertura + "Par" + fechamento);
            } else {
                lblResultado.setText(abertura + "Nulo" + fechamento);
            }    
        } else {
            lblResultado.setText(abertura + "Ímpar" + fechamento);
        }
